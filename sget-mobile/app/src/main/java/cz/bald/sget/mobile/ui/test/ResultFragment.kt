...
class ResultFragment(private val result: Result) : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.test_result_questions_value.text = getString(
            R.string.test_result_questions_value,
            result.correctQuestions, result.questions
        )
        view.test_result_points_value.text = getString(
            R.string.test_result_points_value, result.points,
            result.maxPoints
        )
        val pct = 100.0 * result.points / result.maxPoints
        view.test_result_percentage_value.text =
            getString(R.string.test_result_percentage_value, pct)
