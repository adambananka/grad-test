...
import cz.bald.sget.mobile.extension.toPrintable
    ...
    inner class ResultViewHolder(private val view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(result: Result) {
            ...
            view.result_item_setting_header.text = resource.getString(
                R.string.result_list_setting_header,
                result.test.subject.getSubjectName(),
                result.test.year
            )
            ...
            view.result_item_points.text = resource.getString(
                R.string.result_list_points,
